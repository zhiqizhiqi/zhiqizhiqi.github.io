...
在宏观经济学没有能力全面论述的情况下，LLM 以人工智能最前沿的定性也基本决定了其在中国市场“自主可控”的出身。当然，对于实际的商业路径上，也必须围绕中国市场的特点。
...
- 更强的算法性能和小样本学习能力
  ...
  - 更大规模：对人类文明的内容“learning”更广更深
    - Seq Len：提升 seq len 的长度，从O(N**2)下降到O(n)，更进一步使用 explicit memory 来增加输入长度
...
- 最近 2~3 年 LLM 的发展在短期极大的牺牲了 Performance 维度的表现，但显著推进了 Generality 的表现（在广度上几乎覆盖了所有人类文明的内容），这是 AI 首次在通用性获得如此巨大的突破。
  ...
  - 超级模型（LLM）的拟合能力使得从“语言”数据的生成结构建模上学习到了其背后的智能，是智能提升通用性的巨大“捷径”；
