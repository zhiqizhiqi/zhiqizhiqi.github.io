...
作者：[Zhiqi](https://zhiqizhiqi.github.io/)
...
- 放眼未来，智能在新的 Generality 水平下，再次出现 Performance 的阶跃会是下个智能高峰
  ...
  - 强 Generality 中 Performance：在 LLM 的通用性上，进一步追求更强的 Performance，尤其是如何将类似于 AlphaGo 等工作中 RL 的框架引入到 LLM 的训练中。设想一个可以 Self-play(或者说 "Self-talk") 的 LLM ，其智能水平能够不断地自我提升，而不再收到训练数据分布和数量的约束，其智能水平能够到怎样的水平？！

<br /><br /><br />

作者：张志齐（WeChat：zhangzhiqi0106）
